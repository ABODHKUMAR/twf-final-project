...
//         console.log("Considering edge:", node, "->", to, "with distance:", dist, "and cost_here:", cost_here);
//         ans = Math.min(ans, cost_here + rec(to, ((vis_mask | (1 << to)) & req_mask), (w_mask | (1 << to)) & req_mask, mask_to_weight, req_mask));
//     }
